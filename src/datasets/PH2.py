...
class PH2(torch.utils.data.Dataset):
    ...
    def __init__(self, data_path=DATA_PATH, transform=None):
        ...
        for sample_dir in sample_dirs:
            ...
            image_path = os.path.join(sample_dir, f'{sample_id}_Dermoscopic_Image', f'{sample_id}.bmp')
            mask_path = os.path.join(sample_dir, f'{sample_id}_lesion', f'{sample_id}_lesion.bmp')
...
if __name__ == "__main__":
    train_loader, val_loader, test_loader = PH2.get_dataloaders(batch_size=4, num_workers=2)
